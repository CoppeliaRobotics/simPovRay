 ...
 *---------------------------------------------------------------------------
 * $File: //depot/povray/3.6-release/source/parstxtr.cpp $
 * $Revision: #3 $
 * $Change: 3032 $
...
IMAGE *Parse_Image (int Legal)
{
   ...
   END_CASE
     ...
     CASE (JPEG_TOKEN)
       Image->File_Type = JPEG_FILE;
       Name=Parse_C_String(true);
       Read_JPEG_Image(Image, Name);
       POV_FREE(Name);
       EXIT
     END_CASE
     ...
     CASE (TIFF_TOKEN)
       ...
       Image->File_Type = TIFF_FILE;
       Name=Parse_C_String(true);
       Read_Tiff_Image(Image, Name);
       POV_FREE(Name);
       EXIT
     END_CASE

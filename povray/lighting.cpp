    ...
    switch(Texture->Type)
    {
      ...
      case UV_MAP_PATTERN:
        ...
        if ((t = Cur->Vals.Texture))
        {
            ...
            TPATTERN* nxt = t->Next; t->Next = Texture->Next;
            do_texture_map(Result_Colour, t, TPoint, Raw_Normal, Ray, Weight, Ray_Intersection, Shadow_Flag);
            t->Next = nxt;
        }
        break;
      case BITMAP_PATTERN:
        Warp_EPoint (TPoint, IPoint, (TPATTERN *)Texture);
        if ((t = material_map(TPoint, Texture)))
        {
                ///////////////////////////////////////////////////////////////////////////////
                //                                                                           //
                // @CoppeliaSim@                                                                   //

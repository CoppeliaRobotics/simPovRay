 ...
 *---------------------------------------------------------------------------
 * $File: //depot/povray/3.6-release/source/express.cpp $
 * $Revision: #3 $
 * $Change: 3032 $
           ...
           else
           {
             ...
             for (i=0;i<Terms;i++)
               Colour[i]=(COLC)Express[i];
                ...
                // a following one. One possible solution would be to pass a flag up to      //
                // Parse_Num_Factor so that this function can immediately swap components    //
                // when necessary                                                            //
                //                                                                           //
                ///////////////////////////////////////////////////////////////////////////////
